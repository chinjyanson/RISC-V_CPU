...
VL_ATTR_COLD void Vcpu___024root__trace_init_sub__TOP__0(Vcpu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+33,"CONTROL_WIDTH", false,-1, 31,0);
    tracep->declBus(c+34,"IMM_WIDTH", false,-1, 31,0);
    tracep->declBit(c+25,"clk", false,-1);
    tracep->declBit(c+26,"rst", false,-1);
    tracep->declBus(c+27,"a0", false,-1, 31,0);
    tracep->declBus(c+13,"RegWrite", false,-1, 2,0);
    tracep->declBus(c+14,"MemWrite", false,-1, 1,0);
    ...
    tracep->declBus(c+13,"RegWrite_i", false,-1, 2,0);
    tracep->declBus(c+18,"ResultSrc_i", false,-1, 1,0);
    tracep->declBus(c+14,"MemWrite_i", false,-1, 1,0);
    ...
    tracep->declBus(c+32,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBit(c+25,"clk", false,-1);
    tracep->declBus(c+14,"WE", false,-1, 1,0);
    ...
    tracep->declBus(c+32,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBit(c+25,"clk", false,-1);
    tracep->declBus(c+13,"WE3", false,-1, 2,0);
    ...
    tracep->declBus(c+29,"input1", false,-1, 31,0);
    tracep->declBus(c+3,"input2", false,-1, 31,0);
    tracep->declBus(c+36,"input3", false,-1, 31,0);
    ...
    tracep->declBus(c+13,"RegWrite_o", false,-1, 2,0);
    tracep->declBus(c+14,"MemWrite_o", false,-1, 1,0);
...
VL_ATTR_COLD void Vcpu___024root__trace_full_sub_0(Vcpu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+10,((7U & (vlSelf->cpu__DOT__Instr 
                                    >> 0xcU))),3);
    bufp->fullBit(oldp+11,((1U & (vlSelf->cpu__DOT__Instr 
                                  >> 0x1eU))));
    bufp->fullIData(oldp+12,(vlSelf->cpu__DOT__pc__DOT__PC),32);
    bufp->fullCData(oldp+13,(vlSelf->cpu__DOT__RegWrite),3);
    bufp->fullCData(oldp+14,(vlSelf->cpu__DOT__MemWrite),2);
    ...
    bufp->fullIData(oldp+22,(vlSelf->cpu__DOT__alu__DOT__Result),32);
    ...
    bufp->fullIData(oldp+29,(vlSelf->cpu__DOT__alu__DOT__data__DOT__data_mem_register
                             [(0xffU & vlSelf->cpu__DOT__ALUResult_o)]),32);
    bufp->fullIData(oldp+30,((vlSelf->cpu__DOT__pc__DOT__PC 
    ...
    bufp->fullIData(oldp+35,(vlSelf->cpu__DOT__Result),32);
    bufp->fullIData(oldp+36,(vlSelf->cpu__DOT__alu__DOT__resultMux__DOT__input3),32);
    bufp->fullIData(oldp+37,(vlSelf->cpu__DOT__pc__DOT__pc_mux__DOT__input3),32);
}
