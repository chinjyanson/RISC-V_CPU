...
void Vcpu___024root__trace_chg_sub_0(Vcpu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgCData(oldp+9,((7U & (vlSelf->cpu__DOT__Instr 
                                      >> 0xcU))),3);
        bufp->chgBit(oldp+10,((1U & (vlSelf->cpu__DOT__Instr 
                                     >> 0x1eU))));
        bufp->chgIData(oldp+11,(vlSelf->cpu__DOT__pc__DOT__PC),32);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        bufp->chgCData(oldp+12,(vlSelf->cpu__DOT__RegWrite),3);
        bufp->chgCData(oldp+13,(vlSelf->cpu__DOT__MemWrite),2);
        ...
        bufp->chgIData(oldp+21,(vlSelf->cpu__DOT__alu__DOT__Result),32);
    ...
    bufp->chgIData(oldp+28,(vlSelf->cpu__DOT__alu__DOT__data__DOT__data_mem_register
                            [(0xffU & vlSelf->cpu__DOT__ALUResult_o)]),32);
    bufp->chgIData(oldp+29,((vlSelf->cpu__DOT__pc__DOT__PC 
