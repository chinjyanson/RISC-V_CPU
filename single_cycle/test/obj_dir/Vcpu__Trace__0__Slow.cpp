...
VL_ATTR_COLD void Vcpu___024root__trace_init_sub__TOP__0(Vcpu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+33,"a0", false,-1, 31,0);
    tracep->pushNamePrefix("cpu ");
    tracep->declBus(c+38,"ADDRESS_WIDTH", false,-1, 31,0);
    tracep->declBus(c+39,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+40,"CONTROL_WIDTH", false,-1, 31,0);
    tracep->declBus(c+41,"IMM_WIDTH", false,-1, 31,0);
    tracep->declBit(c+31,"clk", false,-1);
    tracep->declBit(c+32,"rst", false,-1);
    tracep->declBus(c+33,"a0", false,-1, 31,0);
    ...
    tracep->declBus(c+42,"Result", false,-1, 31,0);
    tracep->declBit(c+24,"ALUResult_o", false,-1);
    ...
    tracep->declBit(c+34,"Zero_o", false,-1);
    tracep->declBus(c+33,"a0", false,-1, 31,0);
    tracep->declBus(c+25,"ALUResult_o", false,-1, 31,0);
    tracep->declBus(c+4,"SrcA", false,-1, 31,0);
    tracep->declBus(c+26,"SrcB", false,-1, 31,0);
    tracep->declBus(c+35,"Result", false,-1, 31,0);
    tracep->declBus(c+5,"regOp2", false,-1, 31,0);
    tracep->declBus(c+36,"ReadData", false,-1, 31,0);
    tracep->pushNamePrefix("ALU ");
    tracep->declBus(c+40,"CONTROL_WIDTH", false,-1, 31,0);
    tracep->declBus(c+39,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+19,"ALUctrl", false,-1, 2,0);
    tracep->declBus(c+4,"SrcA", false,-1, 31,0);
    tracep->declBus(c+26,"SrcB", false,-1, 31,0);
    tracep->declBus(c+25,"ALUResult", false,-1, 31,0);
    tracep->declBit(c+34,"Zero", false,-1);
    ...
    tracep->declBus(c+27,"A", false,-1, 7,0);
    ...
    tracep->declBus(c+39,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+41,"CONTROL_WIDTH", false,-1, 31,0);
    tracep->declBus(c+21,"control", false,-1, 1,0);
    tracep->declBus(c+25,"input0", false,-1, 31,0);
    tracep->declBus(c+36,"input1", false,-1, 31,0);
    tracep->declBus(c+3,"input2", false,-1, 31,0);
    tracep->declBus(c+43,"input3", false,-1, 31,0);
    ...
    tracep->declBit(c+34,"Zero_i", false,-1);
    ...
    tracep->declBus(c+28,"ImmSrc", false,-1, 1,0);
    ...
    tracep->declBus(c+19,"ALUctrl_o", false,-1, 2,0);
    tracep->declBit(c+20,"ALUsrc_o", false,-1);
    tracep->declBus(c+28,"ImmSrc_o", false,-1, 1,0);
    tracep->declBus(c+23,"PCsrc_o", false,-1, 1,0);
    ...
    tracep->declBus(c+41,"IMM_WIDTH", false,-1, 31,0);
    tracep->declBus(c+1,"instr_i", false,-1, 31,0);
    tracep->declBus(c+28,"ImmSrc_i", false,-1, 1,0);
    tracep->declBus(c+22,"ImmOp_o", false,-1, 31,0);
    tracep->popNamePrefix(2);
    ...
    tracep->declBus(c+37,"input1", false,-1, 31,0);
    tracep->declBus(c+29,"input2", false,-1, 31,0);
    tracep->declBus(c+44,"input3", false,-1, 31,0);
...
VL_ATTR_COLD void Vcpu___024root__trace_full_sub_0(Vcpu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+24,((1U & vlSelf->cpu__DOT____Vcellout__alu__ALUResult_o)));
    bufp->fullIData(oldp+25,(vlSelf->cpu__DOT____Vcellout__alu__ALUResult_o),32);
    bufp->fullIData(oldp+26,(vlSelf->cpu__DOT__alu__DOT__SrcB),32);
    bufp->fullCData(oldp+27,((0xffU & vlSelf->cpu__DOT____Vcellout__alu__ALUResult_o)),8);
    bufp->fullCData(oldp+28,(vlSelf->cpu__DOT__control__DOT__ImmSrc),2);
    bufp->fullIData(oldp+29,((1U & vlSelf->cpu__DOT____Vcellout__alu__ALUResult_o)),32);
    bufp->fullIData(oldp+30,(vlSelf->cpu__DOT__pc__DOT__next_PC),32);
    bufp->fullBit(oldp+31,(vlSelf->clk));
    bufp->fullBit(oldp+32,(vlSelf->rst));
    bufp->fullIData(oldp+33,(vlSelf->a0),32);
    bufp->fullBit(oldp+34,((vlSelf->cpu__DOT__alu__DOT__SrcA 
                            == vlSelf->cpu__DOT__alu__DOT__SrcB)));
    bufp->fullIData(oldp+35,(((2U & (IData)(vlSelf->cpu__DOT__Resultsrc))
    ...
    bufp->fullIData(oldp+36,(vlSelf->cpu__DOT__alu__DOT__data__DOT__data_mem_register
                             [(0xffU & vlSelf->cpu__DOT____Vcellout__alu__ALUResult_o)]),32);
    bufp->fullIData(oldp+37,((vlSelf->cpu__DOT__pc__DOT__PC 
                              + vlSelf->cpu__DOT__ImmOp)),32);
    bufp->fullIData(oldp+38,(8U),32);
    bufp->fullIData(oldp+39,(0x20U),32);
    bufp->fullIData(oldp+40,(3U),32);
    bufp->fullIData(oldp+41,(2U),32);
    bufp->fullIData(oldp+42,(vlSelf->cpu__DOT__Result),32);
    bufp->fullIData(oldp+43,(vlSelf->cpu__DOT__alu__DOT__resultMux__DOT__input3),32);
    bufp->fullIData(oldp+44,(vlSelf->cpu__DOT__pc__DOT__pc_mux__DOT__input3),32);
}
