...
VL_INLINE_OPT void Vcpu::_sequent__TOP__1(Vcpu__Syms* __restrict vlSymsp) {
    ...
    // Variables
    CData/*7:0*/ __Vdlyvdim0__cpu__DOT__data__DOT__register__DOT__reg_array__v0;
    CData/*0:0*/ __Vdlyvset__cpu__DOT__data__DOT__register__DOT__reg_array__v0;
    CData/*7:0*/ __Vdlyvdim0__cpu__DOT__data__DOT__data__DOT__data_mem_register__v0;
    CData/*0:0*/ __Vdlyvset__cpu__DOT__data__DOT__data__DOT__data_mem_register__v0;
    CData/*7:0*/ __Vdlyvdim0__cpu__DOT__data__DOT__data__DOT__data_mem_register__v1;
    CData/*4:0*/ __Vdlyvlsb__cpu__DOT__data__DOT__data__DOT__data_mem_register__v1;
    CData/*0:0*/ __Vdlyvset__cpu__DOT__data__DOT__data__DOT__data_mem_register__v1;
    CData/*7:0*/ __Vdlyvdim0__cpu__DOT__data__DOT__data__DOT__data_mem_register__v2;
    CData/*4:0*/ __Vdlyvlsb__cpu__DOT__data__DOT__data__DOT__data_mem_register__v2;
    ...
    SData/*15:0*/ __Vdlyvval__cpu__DOT__data__DOT__data__DOT__data_mem_register__v1;
    IData/*31:0*/ __Vdly__cpu__DOT__PCF;
    IData/*31:0*/ __Vdlyvval__cpu__DOT__data__DOT__register__DOT__reg_array__v0;
    IData/*31:0*/ __Vdlyvval__cpu__DOT__data__DOT__data__DOT__data_mem_register__v0;
    // Body
    ...
    vlTOPp->cpu__DOT__data__DOT__ReadDataW = vlTOPp->cpu__DOT__data__DOT__data__DOT__data_mem_register
        [(0xffU & vlTOPp->cpu__DOT__data__DOT__ALUResultM)];
    if ((1U == (IData)(vlTOPp->cpu__DOT__MemWriteM))) {
        __Vdlyvval__cpu__DOT__data__DOT__data__DOT__data_mem_register__v0 
            = vlTOPp->cpu__DOT__data__DOT__WriteDataM;
        ...
        if ((2U == (IData)(vlTOPp->cpu__DOT__MemWriteM))) {
            __Vdlyvval__cpu__DOT__data__DOT__data__DOT__data_mem_register__v1 
                = (0xffffU & vlTOPp->cpu__DOT__data__DOT__WriteDataM);
            __Vdlyvset__cpu__DOT__data__DOT__data__DOT__data_mem_register__v1 = 1U;
            __Vdlyvlsb__cpu__DOT__data__DOT__data__DOT__data_mem_register__v1 = 0U;
            ...
            if ((3U == (IData)(vlTOPp->cpu__DOT__MemWriteM))) {
                ...
                __Vdlyvlsb__cpu__DOT__data__DOT__data__DOT__data_mem_register__v2 = 0U;
    ...
    vlTOPp->cpu__DOT__ImmSrcE = ((IData)(vlTOPp->cpu__DOT__Drst)
                                  ? 0U : (7U & ((IData)(vlTOPp->cpu__DOT__control__DOT__ControlUnit__DOT__maindec__DOT__controls) 
                                                >> 2U)));
    if ((0U != (IData)(vlTOPp->cpu__DOT__RdW))) {
            ...
            = ((4U & (IData)(vlTOPp->cpu__DOT__RegWriteW))
                ? ((2U & (IData)(vlTOPp->cpu__DOT__RegWriteW))
                    ? ((1U & (IData)(vlTOPp->cpu__DOT__RegWriteW))
                        ? (0xffU & vlTOPp->cpu__DOT__data__DOT__ResultW)
                        : (0xffffU & vlTOPp->cpu__DOT__data__DOT__ResultW))
                    : vlTOPp->cpu__DOT__data__DOT__register__DOT__reg_array
                   [vlTOPp->cpu__DOT__RdW]) : ((2U 
    ...
    if (__Vdlyvset__cpu__DOT__data__DOT__data__DOT__data_mem_register__v1) {
        vlTOPp->cpu__DOT__data__DOT__data__DOT__data_mem_register[__Vdlyvdim0__cpu__DOT__data__DOT__data__DOT__data_mem_register__v1] 
            = (((~ ((IData)(0xffffU) << (IData)(__Vdlyvlsb__cpu__DOT__data__DOT__data__DOT__data_mem_register__v1))) 
                & vlTOPp->cpu__DOT__data__DOT__data__DOT__data_mem_register
                [__Vdlyvdim0__cpu__DOT__data__DOT__data__DOT__data_mem_register__v1]) 
               | ((IData)(__Vdlyvval__cpu__DOT__data__DOT__data__DOT__data_mem_register__v1) 
                  << (IData)(__Vdlyvlsb__cpu__DOT__data__DOT__data__DOT__data_mem_register__v1)));
    }
    if (__Vdlyvset__cpu__DOT__data__DOT__data__DOT__data_mem_register__v2) {
        vlTOPp->cpu__DOT__data__DOT__data__DOT__data_mem_register[__Vdlyvdim0__cpu__DOT__data__DOT__data__DOT__data_mem_register__v2] 
            = (((~ ((IData)(0xffU) << (IData)(__Vdlyvlsb__cpu__DOT__data__DOT__data__DOT__data_mem_register__v2))) 
                & vlTOPp->cpu__DOT__data__DOT__data__DOT__data_mem_register
                [__Vdlyvdim0__cpu__DOT__data__DOT__data__DOT__data_mem_register__v2]) 
               | ((IData)(__Vdlyvval__cpu__DOT__data__DOT__data__DOT__data_mem_register__v2) 
                  << (IData)(__Vdlyvlsb__cpu__DOT__data__DOT__data__DOT__data_mem_register__v2)));
    }
