...
VL_ATTR_COLD void Vcpu___024root___ctor_var_reset(Vcpu___024root* vlSelf) {
    ...
    vlSelf->cpu__DOT__Drst = VL_RAND_RESET_I(1);
    ...
    vlSelf->__Vdly__cpu__DOT__PCF = VL_RAND_RESET_I(32);
    vlSelf->__Vdlyvdim0__cpu__DOT__alu__DOT__register__DOT__reg_array__v0 = 0;
    vlSelf->__Vdlyvval__cpu__DOT__alu__DOT__register__DOT__reg_array__v0 = VL_RAND_RESET_I(32);
    vlSelf->__Vdlyvset__cpu__DOT__alu__DOT__register__DOT__reg_array__v0 = 0;
    vlSelf->__VinpClk__TOP__cpu__DOT__Drst = VL_RAND_RESET_I(1);
    vlSelf->__Vchglast__TOP__cpu__DOT__Drst = VL_RAND_RESET_I(1);
