    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgBit(oldp+51,((1U & ((vlTOPp->cpu__DOT__InstrD 
                                           ...
                                           & (vlTOPp->cpu__DOT__InstrD 
                                              >> 5U)))));
            tracep->chgIData(oldp+52,((0x1ffffffU & 
                                       (vlTOPp->cpu__DOT__InstrD 
                                        >> 7U))),25);
            ...
            tracep->chgCData(oldp+54,((0x1fU & (vlTOPp->cpu__DOT__InstrD 
                                                >> 0x14U))),5);
            tracep->chgCData(oldp+55,((0x1fU & (vlTOPp->cpu__DOT__InstrD 
                                                >> 7U))),5);
            tracep->chgIData(oldp+56,(vlTOPp->cpu__DOT__alu__DOT__register__DOT__reg_array
                                      [(0x1fU & (vlTOPp->cpu__DOT__InstrD 
                                                 >> 0xfU))]),32);
            tracep->chgIData(oldp+57,(vlTOPp->cpu__DOT__alu__DOT__register__DOT__reg_array
                                      [(0x1fU & (vlTOPp->cpu__DOT__InstrD 
                                                 >> 0x14U))]),32);
            tracep->chgIData(oldp+58,(vlTOPp->cpu__DOT__alu__DOT__RD1E),32);
            tracep->chgIData(oldp+59,(vlTOPp->cpu__DOT__alu__DOT__RD2E),32);
            tracep->chgIData(oldp+60,(vlTOPp->cpu__DOT__alu__DOT__PCE),32);
            tracep->chgIData(oldp+61,(vlTOPp->cpu__DOT__alu__DOT__PCPlus4E),32);
            tracep->chgIData(oldp+62,(vlTOPp->cpu__DOT__alu__DOT__SrcAE),32);
            tracep->chgIData(oldp+63,(vlTOPp->cpu__DOT__alu__DOT__SrcBE),32);
            tracep->chgIData(oldp+64,(vlTOPp->cpu__DOT__alu__DOT__WriteDataE),32);
            tracep->chgIData(oldp+65,(vlTOPp->cpu__DOT__alu__DOT__ExtImmE),32);
            tracep->chgIData(oldp+66,(vlTOPp->cpu__DOT__alu__DOT__ALUResultM),32);
            tracep->chgIData(oldp+67,(vlTOPp->cpu__DOT__alu__DOT__WriteDataM),32);
            tracep->chgIData(oldp+68,(vlTOPp->cpu__DOT__alu__DOT__PCPlus4M),32);
            tracep->chgIData(oldp+69,(vlTOPp->cpu__DOT__alu__DOT__data__DOT__data_mem_register
                                      [(0xffU & vlTOPp->cpu__DOT__alu__DOT__ALUResultM)]),32);
            tracep->chgIData(oldp+70,(vlTOPp->cpu__DOT__alu__DOT__PCPlus4W),32);
            tracep->chgIData(oldp+71,(vlTOPp->cpu__DOT__alu__DOT__ReadDataW),32);
            tracep->chgIData(oldp+72,(vlTOPp->cpu__DOT__alu__DOT__ALUResultW),32);
            tracep->chgIData(oldp+73,(vlTOPp->cpu__DOT__alu__DOT__ResultW),32);
        ...
        tracep->chgBit(oldp+78,(vlTOPp->rst));
        tracep->chgIData(oldp+79,(vlTOPp->a0),32);
    }
}
